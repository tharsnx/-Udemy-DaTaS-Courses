...
def make_graph(list_d):
    ...
    # AVERAGE_RATE NONE REVIEW 0
    plt.figure(1)
    plt.bar(left, average_rate, tick_label = name_instr,
        width = 0.8, color = ['Yellow', 'Skyblue'])
    plt.xticks(rotation = 90)
    plt.xlabel('Instructor')
    plt.ylabel('Average_rate')
    plt.title('AVERAGE_RATE NONE REVIEW 0')
    plt.show()

    # MAX_RATE NONE REVIEW 0
    plt.figure(2)
    plt.bar(left, max_rate ,tick_label = name_instr,
        width = 0.8, color = ['Pink', 'Purple'])
    plt.xticks(rotation = 90)
    plt.xlabel('Instructor')
    plt.ylabel('Max_rate')
    plt.title('MAX_RATE NONE REVIEW 0')
    plt.show()

    # AVERAGE_MAX_RATE NONE REVIEW 0
    plt.figure(3)
    ...
    plt.xlabel('Max_Rate')
    plt.ylabel('Average_rate')
    plt.title('AVERAGE_MAX_RATE NONE REVIEW 0')
    plt.show()

    # AVERAGE_MAX_COMPARE NONE REVIEW 0
    plt.figure(4)
    x = np.arange(len(name_instr))
    bar_width = 0.35
    plt.bar(x - bar_width/2, average_rate, bar_width, label='Average', color='Skyblue')
    plt.bar(x + bar_width/2, max_rate, bar_width, label='Maxrate', color='lightcoral')
    plt.xticks(rotation = 90)
    plt.xlabel('Instructor')
    plt.ylabel('')    
    plt.title('AVERAGE_MAX_COMPARE NONE REVIEW 0')
    ...
    # plt.barh(name_instr, average_rate, color='skyblue')
    # plt.xlabel('Instructor')
    # plt.ylabel('Average_rate')
    # plt.title('Bar Chart Sleep')
